...
function begin_play(){
	...
	if (isEmpty(player1.value) || isEmpty(player2.value)){
		alert("one or more of the player(s) name(s) is empty");
		return;
	}
	...
	document.getElementById('turn_info').innerHTML="Trun for: <b>X</b>";
	started=true;
}
...
function winner()
{
	var arr=[[board_state[0],board_state[1],board_state[2]], [board_state[3],board_state[4],board_state[5]],[board_state[6],board_state[7],board_state[8]],[board_state[0],board_state[3],board_state[6]],[board_state[1],board_state[4],board_state[7]],[board_state[2],board_state[5],board_state[8]],[board_state[0],board_state[4],board_state[8]],[board_state[2],board_state[4],board_state[6]]];
		...
		else
		{
			if(turn==1)
			{
				if(board_state[index]==-1)
				{
					...
					toggle_move()
					document.getElementById('turn_info').innerHTML="Trun for: <b>O</b>";
					if(winner()==1)
					{
